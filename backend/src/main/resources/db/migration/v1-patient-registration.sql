...
CREATE TABLE patient_dependent (
    ...
    CONSTRAINT fk_principal FOREIGN KEY(principal_patient_id) REFERENCES patient(patient_id),
    CONSTRAINT fk_dependent FOREIGN KEY(dependent_patient_id) REFERENCES patient(patient_id)
);
